...
def fetch_github_version(url: ParseResult, version_extractor: str) -> Optional[str]:
    ...
    filtered = [
        x for x in entries if x is not None and extract_version(x, version_extractor)
    ]
